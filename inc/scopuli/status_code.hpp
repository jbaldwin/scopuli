...
inline const std::string status_code_http_101_switching_protocols{
...
inline const std::string status_code_http_203_non_authoritative_information{
    "203 Non-Authoritative Information"};
inline const std::string status_code_http_204_no_content{"204 No Content"};
inline const std::string status_code_http_205_reset_content{
    "205 Reset Content"};
inline const std::string status_code_http_206_partial_content{
    "206 Partial Content"};
inline const std::string status_code_http_207_multi_status{"207 Multi-Status"};
inline const std::string status_code_http_208_already_reported{
    "208 Already Reported"};
inline const std::string status_code_http_226_im_used{"226 IM Used"};

inline const std::string status_code_http_300_multiple_choices{
    "300 Multiple Choices"};
inline const std::string status_code_http_301_moved_permanently{
...
inline const std::string status_code_http_307_temporary_redirect{
    "307 Temporary Redirect"};
inline const std::string status_code_http_308_permanent_redirect{
...
inline const std::string status_code_http_402_payment_required{
...
inline const std::string status_code_http_405_method_not_allowed{
    "405 Method Not Allowed"};
inline const std::string status_code_http_406_not_acceptable{
    "406 Not Acceptable"};
inline const std::string status_code_http_407_proxy_authentication_required{
    "407 Proxy Authentication Required"};
inline const std::string status_code_http_408_request_timeout{
    "408 Request Timeout"};
...
inline const std::string status_code_http_411_length_required{
    "411 Length Required"};
inline const std::string status_code_http_412_precondition_failed{
    "412 Precondition Failed"};
inline const std::string status_code_http_413_payload_too_large{
    "413 Payload Too Large"};
inline const std::string status_code_http_414_uri_too_long{"414 URI Too Long"};
inline const std::string status_code_http_415_unsupported_media_type{
    "415 Unsupported Media Type"};
inline const std::string status_code_http_416_range_not_satisfiable{
    "416 Range Not Satisfiable"};
inline const std::string status_code_http_417_expectation_failed{
    "417 Expectation Failed"};
inline const std::string status_code_http_418_im_a_teapot{"418 I'm a teapot"};
inline const std::string status_code_http_421_misdirected_request{
    "421 Misdirected Request"};
inline const std::string status_code_http_422_unprocessable_entity{
    "422 Unprocessable Entity"};
inline const std::string status_code_http_423_locked{"423 Locked"};
inline const std::string status_code_http_424_failed_dependency{
    "424 Failed Dependency"};
inline const std::string status_code_http_425_too_early{"425 Too Early"};
inline const std::string status_code_http_426_upgrade_required{
    "426 Upgrade Required"};
inline const std::string status_code_http_428_precondition_required{
    "428 Precondition Required"};
inline const std::string status_code_http_429_too_many_requests{
    "429 Too Many Requests"};
inline const std::string status_code_http_431_request_header_fields_too_large{
    "431 Request Header Fields Too Large"};
inline const std::string status_code_http_451_unavailable_for_legal_reasons{
    "451 Unavailable For Legal Reasons"};

inline const std::string status_code_http_500_internal_server_error{
    "500 Internal Server Error"};
inline const std::string status_code_http_501_not_implemented{
    "501 Not Implemented"};
inline const std::string status_code_http_502_bad_gateway{"502 Bad Gateway"};
inline const std::string status_code_http_503_service_unavailable{
    "503 Service Unavailable"};
inline const std::string status_code_http_504_gateway_timeout{
    "504 Gateway Timeout"};
inline const std::string status_code_http_505_http_version_not_supported{
    "505 HTTP Version Not Supported"};
inline const std::string status_code_http_506_variant_also_negotiates{
    "506 Variant Also Negotiates"};
inline const std::string status_code_http_507_insufficient_storage{
    "507 Insufficient Storage"};
inline const std::string status_code_http_508_loop_detected{
    "508 Loop Detected"};
inline const std::string status_code_http_510_not_extended{"510 Not Extended"};
inline const std::string status_code_http_511_network_authentication_required{
